...
import { Clock, MapPin, Radio, FileText, AlertTriangle, User, Home, CheckCircle } from "lucide-react"
...
export function HomeScreen({ userName = "User", onNavigate = () => {} }: HomeScreenProps) {
